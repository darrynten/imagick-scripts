#!/bin/bash
# 
# Developed by Fred Weinhaus and Dirk Lemstra 10/2/2015 .... revised 10/2/2015
#
# ------------------------------------------------------------------------------
# 
# Licensing:
...
####
#
# USAGE: autotrim [-m mode] [-f fuzzval] [-c coords] [-l left] [-r right ] 
# [-t top ] [-b bottom ] [-p preview] infile outfile
